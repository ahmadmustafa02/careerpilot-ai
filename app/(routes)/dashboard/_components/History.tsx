...
function History() {
    ...
    return (
        <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-100 dark:bg-gray-800/50 dark:border-gray-700">
            <div className="mb-8">
            ...
            {isLoading ? (
                ...
                <div className="flex items-center justify-center flex-col py-16">
                    <div className="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center mb-6">
                        <Image src="/idea.png" alt="No history" width={48} height={48} />
                    </div>
                    ...
                    {userHistory?.map((history: any, index: number) => {
                        ...
                        return (
                            <Link href={history?.aiAgentType + "/" + history?.recordId} key={index}>
                                <div className="group p-6 bg-white/60 backdrop-blur-sm rounded-xl border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all duration-200 cursor-pointer dark:bg-gray-800/60 dark:border-gray-600 dark:hover:border-blue-500">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            {agent && (
                                                <div className={`w-12 h-12 bg-gradient-to-br ${getGradientColors(agent.name)} rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200`}>
                                                    <Image 
                                                        src={agent.icon} 
                                                        width={24} 
                                                        height={24} 
